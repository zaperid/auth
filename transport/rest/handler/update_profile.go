...
func UpdateProfileHandler(endpointfn gokitEndpoint.Endpoint) gin.HandlerFunc {
	return func(c *gin.Context) {
		var req endpoint.UpdateProfileRequest
		...
		var res endpoint.UpdateProfileResponse
		{
			...
			var ok bool
			res, ok = rawRes.(endpoint.UpdateProfileResponse)
			if !ok {
